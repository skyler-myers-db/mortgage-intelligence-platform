...
- [Genie transcript store](project_genie_transcript_store.md) — one module-level store backs both Genie surfaces; clear it per test, and gate the route's cached payload on submittedQuestion.
