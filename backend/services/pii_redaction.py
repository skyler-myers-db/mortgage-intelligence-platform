...
# ---------------------------------------------------------------------------
# Lender vocabulary + resolver: split into ``backend.services.lender_ref`` on
# 2026-08-08 (this module crossed the 900-line monolith gate). Re-exported here
# because every caller and test imports these names from ``pii_redaction`` --
# the split is a file boundary, not an API change.
# ---------------------------------------------------------------------------
from backend.services.lender_ref import (  # noqa: E402
    _LENDER_REF_MAP,
    LenderRefResolver,
