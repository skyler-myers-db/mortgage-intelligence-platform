...
class DatabricksAnalyticsRepository:
    ...
    _STATE_AVM_VALUE_SQL = (
        ...
        "  CAST(SUM(CASE WHEN current_lien_balance <= GREATEST(20000000, 10 * COALESCE(avm_value, 0)) "
        "    THEN current_lien_balance ELSE 0 END) AS BIGINT) AS total_lien_balance_usd, "
