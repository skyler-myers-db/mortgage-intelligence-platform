import { useEffect, useLayoutEffect, useRef, useState, useSyncExternalStore, type FocusEvent } from 'react';
...
export function Toaster() {
  ...
  // A removed element fires no blur, so dismissing the toast that holds
  // focus would otherwise leave every later toast paused.
