...
/**
 * S6 approval-funnel stage evidence. Every funnel number opens the drawer
 * with the exact object(s) the count was computed from: population and
 * high-opportunity cite the S1 headline metric view (canonical
 * fn_high_opportunity indicator); the workflow stages cite the live
 * Lakebase tables the approval workflow writes.
 */
