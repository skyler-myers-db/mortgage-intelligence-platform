...
2. **How many borrowers in Chicago are in the money right now, and which ZIPs concentrate them?**
   ...
   Source: `mip_demo.gold.lead_scores`, `mip_demo.gold.borrower_360`.
...
3. **Which ZIP codes in California have the highest refi pool?**
   ...
   Source: `mip_demo.gold.lead_population`, `mip_demo.semantics.lead_generation_metric_view`.
...
5. **How big is the 2020–2022 sub-3% lock-in cohort across all six states?**
   ...
   Source: `mip_demo.silver.lien_current`, `mip_demo.semantics.borrower_opportunity_metric_view`.
