...
-- -----------------------------------------------------------------------------
-- Purpose:   Populate `mip_demo.gold.property_owner_bridge` as a CTAS
...
CREATE OR REPLACE TABLE mip_demo.gold.property_owner_bridge AS
SELECT
  s.owner_link_id,
...
FROM mip_demo.silver.owner_property_bridge AS s
