...
def _full_capability_settings() -> Settings:
    return Settings(
        ...
        mip_ai_gateway_inference_table="mip.audit.mip_agent_gateway_llama",
...
def test_growth_agent_home_live_capability_query_param_upgrades_capabilities(
    ...
    assert "freshness-bounded exact inference row" in ai_gateway_detail
    assert "deployment proof ledger" in ai_gateway_detail
